...
findAssocs(tdm,"management",0.5)
findAssocs(tdm,"experience",0.5)
findAssocs(tdm,"knowledge",0.4)
findAssocs(tdm,"skill",0.5)
findAssocs(tdm,"skills",0.4)
findAssocs(tdm,"degree",0.5)
findAssocs(tdm,"database",0.5)
findAssocs(tdm,"understanding",0.49)
